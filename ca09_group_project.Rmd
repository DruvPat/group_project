...
> 
1. There are 74 variables and 5442 rows
2. There are 37 numeric variables. They are id, scrape_id, host_id, host_listings_count, host_total_listings_count, latitude, longitude, accommodates, bedrooms, beds, minimum_nights, maximum_nights,  minimum_minimum_nights, maximum_minimum_nights, minimum_maximum_nights, maximum_maximum_nights, minimum_nights_avg_ntm, maximum_nights_avg_ntm, availability_30, availability_60, availability_90, availability_365, number_of_reviews, number_of_reviews_ltm, number_of_reviews_130d, review_scores_rating, review_scores_accuracy, review_scores_cleanliness, review_scores_checkin, review_scores_communication, review_scores_location, review_scores_value, calculated_host_listings_count, calculated_host_listings_count_entire_homes, calculated_host_listings_count_private_rooms, calculated_host_listings_count_shared_rooms, reviews_per_month
3. Categorical vriables:  host_verifications, host_has_profile_pic, host_identity_verified, neighbourhood, neighbourhood_cleansed, property_type , room_type, has_availability, instant_bookable
...
>
1. The most common value is 1 day. 
2. 90, 30 days stand out among those common values
3. the unusual values are either 1 month or 1 quater, which indicates that house hosts have high intention to let their house for long-term purpose (1 month or 1 quater)
...
Step 3: * Creating informative visualizations.
        * `ggplot2::ggplot()`
...
> What are the correlations between variables? Does each scatterplot support a linear relationship between variables? Do any of the correlations appear to be conditional on the value of a categorical variable?
        ...
        1. Vertical Bar: Which type of Houses are most common in Brussels? (In terms of Number of Rooms)
        2. Histogram: What is the AirBnB Price distribution in Brussels 
        3. Scatterplot: Host Reponse Rate vs Host Total Listings
        4. Scatterplot: How is the price of the listing related to how long a host has been a host for? 
        5. - How is Host quality correlated with Price? (Host Quality = Host Response Rate, Host verification, Host Picture, Host Acceptance Rate) 
                - VIF test to check col linearity between variables 
           - What is the relationship between price and the host being a Super Host (Logit/Probit Model)
...
Model 3: price_4_nights vs. prop_type_simplified`, `number_of_reviews`, `review_scores_rating`, 'bathrooms', 'bedrooms', and beds' (Do VIF Test)

Model 4: price_4_nights vs. prop_type_simplified`, `number_of_reviews`, `review_scores_rating`, 'bathrooms', 'bedrooms', 'beds', and 'superhosts' (Do VIF Test)

Model 5: price_4_nights vs. prop_type_simplified`, `number_of_reviews`, `review_scores_rating`, 'bathrooms', 'bedrooms', 'beds', 'superhosts', instant_bookable (Do VIF Test)

Model 6: price_4_nights vs. prop_type_simplified`, `number_of_reviews`, `review_scores_rating`, 'bathrooms', 'bedrooms', 'beds', 'superhosts', 'neighbourhood_simplified'(Do VIF Test)

Model 7: Model 6: price_4_nights vs. prop_type_simplified`, `number_of_reviews`, `review_scores_rating`, 'bathrooms', 'bedrooms', 'beds', 'superhosts', 'neighbourhood_simplified', reviews_per_month (Do VIF Test)
...
- Summary Table construction with all 7 models 

- Simulation Test with 95% CI
